package com.fenix.base.interceptor;

import com.fenix.base.helper.FileHeaderHelper;
 ...
 * 文件拦截器
 */
public class FileHeaderInterceptor implements HandlerInterceptor {
        ...
        if (request != null && request instanceof MultipartHttpServletRequest) {
            ...
            while (iterator.hasNext()) {
                ...
                if(file.length>HEADER_LENGTH){
                    ...
                    List<String> headerList = FileHeaderHelper.getInstance().getAllowFileHeaders() ;
